const SummarySection = ({ darkMode }) => (
  <div className="space-y-4">
    <h3 className={`text-lg font-semibold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>This Week's Progress</h3>
    ...
    <div className={`p-4 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
      ...
      <div className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>You've been consistent with your coding practice this week. Keep it up!</div>
    </div>
  </div>
);
